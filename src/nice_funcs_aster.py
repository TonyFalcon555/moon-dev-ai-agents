...
# Add Aster Dex Trading Bots to path (configurable via env, with sensible default)
aster_bots_path = os.getenv('ASTER_BOTS_PATH', '/Users/md/Dropbox/dev/github/Aster-Dex-Trading-Bots')
